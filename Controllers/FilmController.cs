...
namespace IJustWatched.Controllers
{
    public class FilmController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate")] Film film)
        {
            if (id != film.Id)
            {
                return NotFound();
